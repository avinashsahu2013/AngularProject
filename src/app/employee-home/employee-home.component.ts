...
export class EmployeeHomeComponent implements OnInit {
  ...
  navigateEmployeeDetail(id) {
      // alert(id);
      // this.dataservice.currentID.subscribe(ID => this.ID = ID);
      this.dataservice.changeMyID(id);
      // tslint:disable-next-line: max-line-length
      this.router.navigate(['/employeedetails', id]); /// fragment is just for going to the soecific position in the page
  }
